...
const artists = [
  { img: joel, name: "Joel Brown", genre: "Afrobeats", bio: "Artista urbano de Santa Marta con millones de reproducciones. Su estilo fusiona ritmos caribeños con beats modernos.", tracks: ["O'Mama", "Plan A", "La Chinita"], spotify: "https://open.spotify.com/intl-es/artist/3gDO9U6A877KG5a40t6Fk7?si=8JD1_e80SAi_WBjJHwo04w", youtube: "https://www.youtube.com/@JoelBrown_tv" },
  ...
  { img:sanjuan, name: "San Juan", genre: "Reggaetón / Dancehall", bio: "Cantautor con un estilo único que combina elementos del reggaetón y el dancehall. Su música ha sido destacada en plataformas de streaming internacionales.", tracks: ["La Chinita", "Recuerdame", "2 Veces Santa"], spotify: "https://open.spotify.com/intl-es/artist/7DYcGRiCfTdJT0zEvdFe7S?si=3daz4n2rRBSoGlj5ag4QuQ", youtube: "https://www.youtube.com/@SanjuanOfficial" },
  { img: naar, name: "Naar", genre: "Trap", bio: "Rapper y productor emergente que ha ganado reconocimiento por su estilo auténtico y letras introspectivas. Su música ha resonado con una audiencia joven en toda América Latina.", tracks: ["Como Sería", "Dame LXZ", "Ene Towers"], spotify: "https://open.spotify.com/intl-es/artist/2cPfw567WdgfmGNpKKKkFm?si=jT5YUVxiSCCIVF8vEo05WQ", youtube: "https://www.youtube.com/@ELNaaRMusic" },
  ...
  { img: oscar, name: "Oscar  olina", genre: "Popular", bio: "Cantautor de musica popular colombiana con una carrera consolidada. Su estilo combina elementos tradicionales con influencias contemporáneas.", tracks: [""], spotify: "#", youtube: "#" },
