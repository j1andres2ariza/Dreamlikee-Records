...
import nar from "../assets/nar.jpeg";
...
const artists = [
  ...
  { img: nar, name: "Naar", genre: "Trap", bio: "Rapper y productor emergente que ha ganado reconocimiento por su estilo auténtico y letras introspectivas. Su música ha resonado con una audiencia joven en toda América Latina.", tracks: ["Como Sería", "Dame LXZ", "Toy Botao"], spotify: "https://open.spotify.com/intl-es/artist/2cPfw567WdgfmGNpKKKkFm?si=jT5YUVxiSCCIVF8vEo05WQ", youtube: "https://www.youtube.com/@ELNaaRMusic" },
