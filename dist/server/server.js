...
async function getStartManifest(matchedRoutes) {
  const { tsrStartManifest } = await import("./assets/_tanstack-start-manifest_v-Dfoxw-Lz.js");
...
async function loadEntries() {
  const [routerEntry, startEntry, pluginAdapters] = await Promise.all([
    import("./assets/router-Ztu87oLR.js"),
...
var ROUTER_BASEPATH = "dreamlikee";
var SERVER_FN_BASE = "/dreamlikee/_serverFn/";
